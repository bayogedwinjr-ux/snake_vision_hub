...
-- =============================================
-- Snakes Table - Stores species metadata
-- =============================================
...
CREATE TABLE IF NOT EXISTS observations (
    ...
    picture_url LONGTEXT DEFAULT NULL,
...
-- =============================================
-- Insert 28 Philippine Snake Species
-- =============================================
...
('Brahminy Blind Snake', 'Indotyphlops braminus', 'Non-venomous', 'Least concern', 'Now found on nearly every continent (except Antarctica). It is widespread throughout the Philippines, Southeast Asia, Australia, the Americas, and many oceanic islands.', 'Found underground or under moist leaf litter, rotting logs, and rocks. It thrives in moist, loose soil.', 'Indotyphlops braminus, commonly known as the Brahminy Blind Snake or Flowerpot Snake, is one of the most widely distributed snake species in the world. It is unique for being the only known obligately parthenogenetic snake.', 'Plays a beneficial role in gardens and urban environments by regulating populations of social insects.'),

('Cumings Blind Snake', 'Ramphotyphlops cumingii', 'Non-venomous', 'Least concern', 'Confirmed populations exist on Bohol, Marinduque, Mindanao, Negros, Panay, Cebu, and Polillo.', 'Typically found under leaf litter, rotting logs, or buried in loose, moist soil. It is occasionally unearthed during agricultural activities or garden maintenance.', 'Ramphotyphlops cumingii, commonly known as Cumings Blind Snake, is a small, non-venomous snake endemic to the Philippines.', 'It plays a beneficial role in forest and garden ecosystems by controlling the populations of social insects.');
